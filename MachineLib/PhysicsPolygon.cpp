 ...
 * @param isSensor whether the PhysicsPolygon is a contact Listener AND doesn't have collision or not
 */
void cse335::PhysicsPolygon::InstallPhysics(std::shared_ptr<b2World> world, bool isSensor)
{
 ...
 * @param x Position along x-axis in pixels
 * @param y Position along y-axis in pixels
 */
void cse335::PhysicsPolygon::SetPosition(double x, double y)
{
    if(mBody != nullptr)
    {
